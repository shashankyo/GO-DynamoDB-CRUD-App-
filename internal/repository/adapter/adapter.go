...
func (db *Database) CreateOrUpdate(entity interface, tableName string)(response *dynamodb.PutItemOutput, err){
...
func (db *Database) Delete(condition map[string]interface{}, tableName string)(response *dynamodb.DeleteItemOutput, err){
